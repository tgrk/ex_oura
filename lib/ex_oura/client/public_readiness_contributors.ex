defmodule ExOura.Client.PublicReadinessContributors do
  @moduledoc """
  Provides struct and type for a PublicReadinessContributors
  """
  ...
  def __fields__(:t) do
    [
      ...
      sleep_regularity: {:union, [:integer, :null]}
    ]
  end
end
